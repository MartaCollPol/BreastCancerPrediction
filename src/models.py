...
class Model():
    ...
    def define_model(self, **kwargs):
        ...
        if self.model_name == 'LinearRegression':
            # Model definition.
            model = LinearRegression() # Has no hyperparameters to optimize, used as a base model.
        ...
        if self.model_name == 'LogisticRegression':
            ...
            if self._optimization:
                ...
                self._default_hyperparams_to_optimize = {'penalty': ['l1', 'l2', 'elasticnet'],
        ...
        if self.model_name == 'RandomForest':
            ...
            if self._optimization:
                # Default hyperparameter ranges to explore in hyperparameter optimization.
                self._default_hyperparams_to_optimize = {'n_estimators': [50, 100, 200, 500, 1000],
            ...
            # Hyperparameters to be used when defining the model.
            n_estimators = kwargs.get('n_estimators', 100) # Number of decision trees in Rforest.
            ...
            max_features = kwargs.get('max_features', 'auto') # Number of features to consider when
        ...
        if self._model_name == 'DecisionTree':
            ...
            # Hyperparameters to be used when defining the model.
            criterion = kwargs.get('criterion', 'gini') # Function to measure quality of a split.
            max_depth = kwargs.get('max_depth', None) # Maximum depth of each decision tree.
            min_samples_split = kwargs.get('min_samples_split', 2) # Minimum number of samples
                                                                   # to split an internal node.
            min_samples_leaf = kwargs.get('min_samples_leaf', 1) # Minimum number of samples
        ...
        if self._model_name == 'SVM':
            ...
            degree = kwargs.get('degree', 3) # The degree of the polynomial kernel function 'poly'.
